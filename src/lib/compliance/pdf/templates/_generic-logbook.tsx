...
export function GenericLogbookTemplate({
  ...
  return (
    <Document
      ...
      author={operator.operatorName ?? operator.pilotFirstName ?? "Swarnakasamonitoring"}
    >
      <Page size="A4" style={baseStyles.page}>
        ...
        <Text style={baseStyles.footer} fixed>
          Generated by Swarnakasamonitoring · {generatedAt.toISOString()} · {retentionLabel(spec.retentionMonths)}
        </Text>
      </Page>
    </Document>
  );
